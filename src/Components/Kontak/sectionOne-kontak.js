...
function SectionOneContact() {
    return(
        <div className="container-sectionOneContact">
            <div className="container-fill-sectionOneContact">
                <h1>Butuh Bantuan?</h1>
                <h4 style={{ marginTop: '1.5rem'}}>Layanan Sales & Support</h4>
                <div className="contact-sectionOneContact">
                    <div className="contact-sectionOneContact-left">
                        <a>
                            <span>
                    ...
                    <div className="contact-sectionOneContact-right">
                        <a>
                            <span>
