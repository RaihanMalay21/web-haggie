        ...
        <footer>
            <div className="footer">
                <div className="footer-container">
                    ...
                    <div className="footer-section">
                        ...
                        <ul className="social-media-footer">
                            <li>
                                <a href="https://www.instagram.com/delegasi.co" target="_blank" rel="noopener noreferrer">
                                    <span>
                                    ...
                                    </span>ZOFI (Zona Finance)
                                </a>
                            </li>
                            <li>
                                <a href="https://twitter.com/delegasi_co" target="_blank" rel="noopener noreferrer">
                                    <span>
                            ...
                            <li>
                                <a href="https://www.facebook.com/delegasi.co" target="_blank" rel="noopener noreferrer">
                                    <span>
                ...
                <div className="footer-bottom">
                    <p>&copy; 2024 Zona Finance. All Rights Reserved.</p>
                </div>
            </div>
        </footer>
    );
